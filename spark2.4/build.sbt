...
val spliceVersion = "3.1.0.1979-SNAPSHOT"
...
hbaseVersion := s"2.1.0-${envClassifier.value}"

lazy val hadoopVersion = settingKey[String]("")
//hadoopVersion := s"2.6.0-${envClassifier.value}"
hadoopVersion := s"3.0.0-${envClassifier.value}"

lazy val kafkaVersion = settingKey[String]("")
kafkaVersion := s"2.2.1-${envClassifier.value}"
