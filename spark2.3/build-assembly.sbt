...
assemblyExcludedJars in assembly := {
  val excludedDeps = Set(
    ...
    "hadoop-mapreduce-client-core-3.1.1.3.1.0.0-78.jar",
    "hadoop-mapreduce-client-common-3.1.1.3.1.0.0-78.jar",
    // Conflicts with Spark 2.2.0.cloudera2
    // FIXME What dep brings Spark 2.1.0?
    "spark-yarn_2.11-2.3.2.3.1.0.0-78.jar",
    ...
    "jython-standalone-2.5.3.jar",
    // Exclude Spark jars
    "spark-launcher_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-yarn_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-network-common_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-network-shuffle_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-unsafe_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-tags_2.11-2.3.2.3.1.0.0-78.jar",
    "spark-core_2.11-2.3.2.3.1.0.0-78.jar",
    // FIXME Should spark-avro be excluded as well?
    "spark-avro_2.11-2.4.3.jar",
    // Hadoop
    "hadoop-mapreduce-client-jobclient-3.1.1.3.1.0.0-78.jar",
    "hadoop-aws-3.1.1.3.1.0.0-78.jar",
    "hadoop-yarn-server-common-3.1.1.3.1.0.61-1.jar",
    "hadoop-hdfs-3.1.1.3.1.0.0-78.jar",
    "hadoop-hdfs-3.1.1.3.1.0.0-78-tests.jar",
    "hadoop-core-2.6.0-mr1-cdh5.14.0.jar",
    "hadoop-client-3.1.1.3.1.0.0-78.jar",
    "hadoop-mapreduce-client-app-3.1.1.3.1.0.0-78.jar",
    "hadoop-mapreduce-client-common-3.1.1.3.1.0.0-78.jar",
    "hadoop-auth-3.1.1.3.1.0.0-78.jar",
    "hadoop-mapreduce-client-shuffle-3.1.1.3.1.0.0-78.jar",
    "hadoop-yarn-common-3.1.1.3.1.0.61-1.jar",
    "hadoop-yarn-server-nodemanager-3.1.1.3.1.0.61-1.jar",
    "hadoop-mapreduce-client-core-3.1.1.3.1.0.0-78.jar",
    "hadoop-yarn-server-web-proxy-3.1.1.3.1.0.0-78.jar",
    "hbase-hadoop2-compat-2.0.2.3.1.0.0-78.jar",
    "hadoop-yarn-client-3.1.1.3.1.0.61-1.jar",
    "hadoop-annotations-3.1.1.3.1.0.61-1.jar",
    "hadoop-yarn-api-3.1.1.3.1.0.61-1.jar",
