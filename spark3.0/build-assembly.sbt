...
assemblyExcludedJars in assembly := {
  val excludedDeps = Set(
    ...
    "hadoop-yarn-server-common-3.0.0-cdh6.3.2.jar",
    "hadoop-hdfs-3.0.0-cdh6.3.2.jar",
    "hadoop-hdfs-3.0.0-cdh6.3.2-tests.jar",
    "hadoop-core-2.6.0-mr1-cdh5.14.0.jar",
    "hadoop-client-3.0.0-cdh6.3.2.jar",
    "hadoop-mapreduce-client-app-3.0.0-cdh6.3.2.jar",
    "hadoop-mapreduce-client-common-3.0.0-cdh6.3.2.jar",
    "hadoop-auth-3.0.0-cdh6.3.2.jar",
    "hadoop-mapreduce-client-shuffle-3.0.0-cdh6.3.2.jar",
    "hadoop-yarn-common-3.0.0-cdh6.3.2.jar",
    "hadoop-yarn-server-nodemanager-3.0.0-cdh6.3.2.jar",
    "hadoop-mapreduce-client-core-3.0.0-cdh6.3.2.jar",
    "hadoop-yarn-server-web-proxy-3.0.0-cdh6.3.2.jar",
    "hbase-hadoop2-compat-2.1.0-cdh6.3.2.jar",
    "hadoop-yarn-client-3.0.0-cdh6.3.2.jar",
    "hadoop-annotations-3.0.0-cdh6.3.2.jar",
    "hadoop-yarn-api-3.0.0-cdh6.3.2.jar",
//    "hadoop-common-3.0.0-cdh6.3.2.jar",
    // Others
    "jasper-runtime-5.5.23.jar",
    "findbugs-annotations-1.3.9-1.jar",
    "scalactic_2.12-3.0.8.jar",
    "scala-reflect-2.12.12.jar",
    "scala-xml_2.12-1.0.2.jar",
    "scala-parser-combinators_2.12-1.1.0.jar",
    "scala-compiler-2.12.12.jar",
